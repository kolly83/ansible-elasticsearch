...
```sh
ansible-galaxy install elastic.elasticsearch,7.6.0
```
...
The above installs Elasticsearch 7.6.0 in a single node 'node1' on the hosts 'localhost'.
